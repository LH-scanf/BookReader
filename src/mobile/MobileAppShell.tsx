...
export function MobileAppShell({ sidebarOpen, onCloseSidebar, onOpenSidebar, navigationItems, footerItem, sidebarStatus, message, children }: AppShellProps) {
  return (
    <div className={`bookreader-mobile app-shell ${sidebarOpen ? "sidebar-is-open" : "sidebar-is-closed"}`} data-ui-mode="mobile">
