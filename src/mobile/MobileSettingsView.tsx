...
const parentPage: Partial<Record<Page, Page>> = { sync: "home", advanced: "sync", storage: "home", trash: "home", appearance: "home", updates: "home", about: "home" };
